...
export default function HistoryContent() {
    ...
    const loadDownloads = async () => {
        ...
        try {
            const downloadsData = await axiosInstance.get(`/downloadhistory/${user?._id}`);
    ...
    const handleRemoveFromDownloads = async (downloadId: string) => {
        try {
            console.log("Removing from downloads:", downloadId);
